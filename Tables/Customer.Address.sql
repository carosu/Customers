...
[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF__Address__Modifie__1367E606] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Address] ADD CONSTRAINT [PK__Address__091C2A1BF79F3564] PRIMARY KEY CLUSTERED  ([AddressID]) ON [PRIMARY]
GO
