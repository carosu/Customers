...
[ModifiedDate] [datetime] NOT NULL CONSTRAINT [DF__Person__Modified__108B795B] DEFAULT (getdate())
) ON [PRIMARY]
GO
ALTER TABLE [Customer].[Person] ADD CONSTRAINT [PK__Person__543B448768A7CD6E] PRIMARY KEY CLUSTERED  ([person_ID]) ON [PRIMARY]
GO
